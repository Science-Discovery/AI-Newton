...
impl Objstructure {
    pub fn particle(mass_range: (f64, f64)) -> Self {
        ...
        Objstructure::new(
            ObjType::particle(),
            HashMap::from([
                (ATTR::mass(), Parastructure::new(Some(mass_range))),
                (ATTR::elec(), Parastructure::new(Some((0.0, 0.0)))),
            ]),
        )
    }
    pub fn elec_particle(mass_range: (f64, f64), elec_range: (f64, f64)) -> Self {
        ...
        Objstructure::new(
            ...
            HashMap::from([
                (ATTR::mass(), Parastructure::new(Some(mass_range))),
                (ATTR::elec(), Parastructure::new(Some(elec_range))),
            ]),
        )
    }
}
impl ATTR {
    ...
    pub fn mass() -> Self {
        ATTR::new(ObjType::particle(), "m")
    }
    pub fn elec() -> Self {
        ATTR::new(ObjType::particle(), "e")
    }
}
impl DATA {
    ...
    pub fn posx() -> Concept {
        DATA::data(vec![r!("Particle")], r!("posx"))
    }
    pub fn posy() -> Concept {
        DATA::data(vec![r!("Particle")], r!("posy"))
    }
    pub fn posz() -> Concept {
        DATA::data(vec![r!("Particle")], r!("posz"))
    }
    pub fn dist() -> Concept {
        DATA::data(vec![r!("Particle"), r!("Particle")], r!("dist"))
    }
}
