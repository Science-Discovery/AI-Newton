...
exp_para = {
    "x1": default_parastructure(-3.5, -2.5),
    "x2": default_parastructure(2.5, 3.5),
...
def oscillation_x_1_config() -> ExpStructure:
    expconfig = ExpConfig("oscillation_x_1", 1, exp_para, obj_info, data_info)
