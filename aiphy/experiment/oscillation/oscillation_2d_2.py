...
exp_para = {
    "x1": default_parastructure(-6.5, -5.5),
    "v1": default_parastructure(-2.0, 2.0),
    "x2": default_parastructure(-0.5, 0.5),
    "v2": default_parastructure(-2.0, 2.0),
    "x3": default_parastructure(5.5, 6.5),
    "v3": default_parastructure(-2.0, 2.0),
    "theta": default_parastructure(0, pi)
}
obj_info = {
    "o1": Objstructure.make_particle(4.5, 5.0),
    "o2": Objstructure.make_particle(4.5, 5.0),
    "o3": Objstructure.make_particle(4.5, 5.0),
...
acs0 = [sp.sympify("k1*(-l1 - x1 + x2)/m1"), sp.sympify("(k1*l1 + k1*x1 - k1*x2 - k2*l2 - k2*x2 + k2*x3)/m2"), sp.sympify("k2*(l2 + x2 - x3)/m3")]
...
def do_experiment(t_end: float, t_num: int, error: float, exp_config: ExpConfig):
    ...
    def f(y, t):
        x1, x2, x3, v1, v2, v3 = y
        numeric = {'x1': x1, 'v1': v1, 'x2': x2, 'v2': v2, 'x3': x3, 'v3': v3}
...
def oscillation_2d_2_config() -> ExpStructure:
    expconfig = ExpConfig("oscillation_2d_2", 2, exp_para, obj_info, data_info)
...
def oscillation_2d_2_test():
    expconfig = ExpConfig("oscillation_2d_2", 1, exp_para, obj_info, data_info)
