...
acs0 = [sp.sympify("(-k1*(1-l1/r1)*x1+k2*(1-l2/r12)*(x2-x1))/m1"),
        sp.sympify("k2*(1-l2/r12)*(x1-x2)/m2"),
        sp.sympify("(-k1*(1-l1/r1)*y1+k2*(1-l2/r12)*(y2-y1))/m1"),
        sp.sympify("k2*(1-l2/r12)*(y1-y2)/m2"),]
...
def oscillation_rot_2_config() -> ExpStructure:
    expconfig = ExpConfig("oscillation_rot_2", 2, exp_para, obj_info, data_info)
