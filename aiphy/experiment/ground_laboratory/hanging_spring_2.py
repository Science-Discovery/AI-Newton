...
acs0 = [sp.sympify("-g+(k1*(z0-z1-l1)-k2*(z1-z2-l2))/m1"), sp.sympify("-g+k2*(z1-z2-l2)/m2")]
...
def do_experiment(t_end: float, t_num: int, error: float, exp_config: ExpConfig):
    ...
    def f(y, t):
        z1, z2, v1, v2 = y
        numeric = {'z1': z1, 'v1': v1, 'z2': z2, 'v2': v2}
...
def hanging_spring_2_config() -> ExpStructure:
    expconfig = ExpConfig("hanging_spring_2", 1, exp_para, obj_info, data_info)
...
def test():
    ...
    return do_experiment(2.0, 100, 0.00000001, expconfig)
